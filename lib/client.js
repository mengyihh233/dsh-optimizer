...
function OptimizerSettings(props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      ...scan === null ? [React.createElement("div", { className: "dsh-opt-empty" }, "\u6B63\u5728\u626B\u63CF\u2026")] : scan.issues && scan.issues.length > 0 ? scan.issues.map(
        (issue) => React.createElement(
          ...
          issue.fix && issue.fix !== "none" ? React.createElement("button", {
...
function apply(ctx) {
  ...
  slots.inject(
    ...
    () => slots.register(
      ...
      (props) => React.createElement(OptimizerSettings, { close: props.close })
    )
  );
}
